...
| level   | INT  | 是       | 地图等级 | 0表示：区域级别-返回全部数据、1表示：市级别-返回当前城市一艘船、2表示：表示省份-返回当前省份的一艘船舶 |

### 请求示例:

```bash
{
    "shipNums": ["0004", "0005"], "level": 3
}
```
...
| level   | INT  | 否       | 步长         | 0表示：区域级别-返回全部数据、1表示：市级别-返回当前城市一艘船、2表示：表示省份-返回当前省份的一艘船舶 |
...
### 接口地址：/v1/ship/water_quality/n_p/
...
```bash
{
    "data": {
        "distance": "1.2", // 距离
        "areaId": 12,  // 区域ID
        "ship__name": "QDF-0005",   // 船的编号
        "area__name": "瑞安市", // 船的名称
        "cTime": "2022-06-26T16:00:00Z",  // 探测数据的创建时间
        "cityId": 8,  // 城市ID
        "watersId": 72,  // 水域ID
        "ship__number": "0005",  // 船舶编号
        "mMobile": "",  // 操作人手机号
        "mUser": "",  // 操作人
        "city__name": "温州市",  // 城市名称
        "province__name": "浙江省",  //省份信息
        "waterBodyType": 3,  // 水下异物类型
        "deviceType": 2,  // 探测类别
        "imageAddress": "http://image.yimingkeji.com/river/1656333632386ltTWV.mp4",  // 探测图
        "shipId": 18,  // 船舶ID
        "provinceId": 1,  // 省份ID
        "waters__name": "凤山河",  // 水域名称
        "id": 33,
        "areas": null // 探测面积
    },
    "retCode": 0,
...
### 接口地址：/v1/picture/water_quality_data/
...
{
    "data": {
        "waterQuality__shipId": 74,
        "waterQuality__waters__name": "临城河",
        "oxySaturation": null,
        "lng": "122.1982977",
        "id": 93,
        "waterQuality__name": "疑似暗管04",
        "tp": "0.181",
        "tn": "3.069",
        "conduct": null,
        "ph": null,
        "eTime": "2022-09-26T00:00:00Z",
        "waterQuality__watersId": 68,
        "nh4": null,
        "nh3": null,
        "lat": "29.990978",
        "temp": null,
        "waterQuality__ship__name": "QDF-0029",
        "chlorophy": null,
        "k": null,
        "waterQuality__ship__number": "0029",
        "dissOxy": null,
        "cod": null,
        "turbidity": null
    },
