...
```bash
{
    "waterId": 56,
    "shipName": "冲锋舟六号",
    "cTime": 1650124800 // 传递当天, 返回当天数据, 如果传入历史天数, 返回历史天数信息
}
```
    ...
    "data": [
        {
            "admin_user": "安鹏", // 管理人员
            "event_type": 1, // 未移动
            "c_time": "2022-04-17T02:21:14.356894Z", // 预警事件
            "mobile": "13456905984", // 管理人员电话
            "waters__name": "温瑞塘河", // 水域ID
            "ts": "1650190874", // 上报时间戳
            "duration": 20,  // 预警市场
            "waters__number": "WRTH-001", // 水域编号
            "user": null, // 同乘人员
            "ship__number": "CFZ-0006", // 船的号码
            "lat": "27.9976528333",  // 事件纬度
            "ship_id": 40,  // 船的ID
            "lng": "120.660100833",  // 事件经度
            "ship__name": "冲锋舟六号",  // 船的名称
            "id": 554,  // 预计ID
            "waters_id": 56  // 水域ID
        }
    ],
